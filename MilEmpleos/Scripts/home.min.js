...
else if(win.attachEvent){win.attachEvent("onresize",callMedia);}})(this);﻿$(function(){if(top.location==self.location){menu_mini_activo=false
$(window).scroll(function(){if(menu_mini_activo==false){if($(this).scrollTop()>=100){$('.navbar-fixed-top').hide()
$('.jumbotron').hide()
$(".vacanteEspacioInicial").show()
menu_mini_activo=true}else{if(top.location==self.location){$('.navbar-fixed-top').show()}
$('.jumbotron').show()
$(".vacanteEspacioInicial").hide()}}else if($(this).scrollTop()==0){$('.navbar-fixed-top').show()
$('.jumbotron').show()
$(".vacanteEspacioInicial").hide()
menu_mini_activo=false}});registros=$("#records").val()
if(registros=="")
{$("#totalRegistros").html(0);$("#count_pagination").html("No se encontraron resultados")}else{$("#totalRegistros").html($("#records").val());}}});﻿
